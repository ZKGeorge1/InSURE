...
export default function VerifyInsuranceProof({ submitVerifyInsuranceProof }: { submitVerifyInsuranceProof: (requirementsJson: string) => void }) {
  ...
  return (
    <form
      className="main-form"
      onSubmit={(e: any) => {
        submitVerifyInsuranceProof(requirementsJson)
