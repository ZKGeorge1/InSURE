...
export default function InsuranceProof({ submitInsuranceProof }: { submitInsuranceProof: (reportJson: string, requirementsJson: string) => void }) {
  ...
  return (
    <form
      className="main-form"
      onSubmit={(e: any) => {
        submitInsuranceProof(reportJson, requirementsJson)
